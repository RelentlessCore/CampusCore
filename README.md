...
Follow these steps to run CampusCore locally on your machine.
...
```bash
git clone https://github.com/RelentlessCore/CampusCore.git
cd CampusCore
```
...
Generate the database schema, run migrations, and seed demo data:
